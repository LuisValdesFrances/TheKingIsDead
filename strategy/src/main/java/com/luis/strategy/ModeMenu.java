        ...
        switch (_iMenuState) {
            ...
            case Define.ST_MENU_START:
                ...
                if (dataConfig == null) {
                    ...
                    dataConfig = "" + lang + "\ntrue\ntrue\nfalse";//Anyadir resto de configuraciones;
                    ...
                    btnEasterEgg = new Button(
                        ...
                        public void onButtonPressUp() {
                            ...
                            if (easterEggCount == 8) {
                                ...
                                String newDataConfig = "" + language + "\n" + true + "\n" + notifications + "\n" + game3D;
                                FileIO.getInstance().saveData(newDataConfig, Define.DATA_CONFIG, Main.getInstance().getActivity());
