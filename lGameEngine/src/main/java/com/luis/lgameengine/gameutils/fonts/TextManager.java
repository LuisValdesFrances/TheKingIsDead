 ...
 */
//La funcion de esta clase es pintar textos largos, provinientes de un archivo .TXT, en pantalla.
//Para ello calcula al anchura de este y despues lo divide en linenas que centra, o no, segun unos
//parametros.
public class TextManager {
    ...
    //Convermimos este array, de una sola posicion, en un array con una palabra
    //por posicion.
    ...
    private static void composeText(Image font, String[] words, int rectangle_width) {
        ...
        //System.out.println("Numero de lineas es :" + lines_text);
        ...
        for (int i = 0; i < words.length; i++) {
            if ((size + calulateWidthWords(font, words[i]))
                ...
                //Anyadimos un espacio vacio tras cada palabra siempre EXCEPTO 	SI ES LA ULTIMA PALABRA
                //de la linea o del texto:
                if(i < words.length-1
            ...
            //System.out.println("Anyadido " + words[i] + " " + "a la linea " + e);
...
//        }
    ...
    public static void drawSimpleText(Graphics g, int _iFontSize, String text, int pos_x, int pos_y, int _iAnchor) {
        ...
        if(Font.isGraphicFont()){
            ...
            for (int e = 0; e < text.length(); e++) {
	            ...
	            */
                g.drawRegion(
                        Font.ms_Fonts[_iFontSize],
                        ((Font.getLetterPos(text.charAt(e))) * Font.getFontWidth(_iFontSize)),
                        0,
                        Font.getFontWidth(_iFontSize), Font.getFontHeight(_iFontSize),
                        posX, posY,
                        Font.getFontWidth(_iFontSize), Font.getFontHeight(_iFontSize),
                        Graphics.TOP | Graphics.LEFT, 0, 0, 0,
                        false, false
                );
    ...
    public static void drawInCenter(Graphics g, Image font, String text, int rectangle_width, byte aling, int number_leters) {
        if(Font.isGraphicFont()){
            ...
            int posX;
            int posY = 0;
            int l;//Longitud de la linea mas larga.
            int s;//Posicion del array donde se encuentra la linea mas larga.
            ...
            switch (aling) {
                ...
                case ALING_CENTER:
                    ...
                    if(number_leters > 0 || number_leters == -1)
                        ...
                        g.drawImage(
                                font,
                                ArrayPosX[i] - ((Font.getLetterPos(mCOMPOSE_TEXT[i].charAt(e))) * (font.getWidth() / Font.getNumberChars())),
                                posY, Graphics.TOP | Graphics.LEFT);
                        */
                                g.drawRegion(
                                        font,
                                        ((Font.getLetterPos(mCOMPOSE_TEXT[i].charAt(e))) * (font.getWidth() / Font.getNumberChars())),
                                        0,
                                        font.getWidth() / Font.getNumberChars(), font.getHeight(),
                                        ArrayPosX[i], posY,
                                        font.getWidth() / Font.getNumberChars(), font.getHeight(),
                                        Graphics.TOP | Graphics.LEFT, 0, 0, 0,
                                        false, false
                ...
                case ALING_LEFT:
                    ...
                    //System.out.println("La linea mas larga es la " + (s + 1));
                    ...
                    if(number_leters > 0 || number_leters == -1)
                        ...
                        g.drawImage(font, posX - ((Font.getLetterPos(mCOMPOSE_TEXT[i].charAt(e))) * (font.getWidth() / Font.getNumberChars())),
                            posY,
                ...
                case ALING_RIGHT:
                    ...
                    if(number_leters > 0 || number_leters == -1)
                        ...
                        g.setClip(posX, posY, font.getWidth() / Font.getNumberChars(), font.getHeight());
                        g.drawImage(font,
                                posX - ((Font.getLetterPos(mCOMPOSE_TEXT[i].charAt(e))) * (font.getWidth() / Font.getNumberChars())),
                                posY, Graphics.TOP | Graphics.LEFT);
                        */
                                g.drawRegion(
                                        font,
                    ...
                    if(number_leters > 0 || number_leters == -1)
                        for (int i = 0; i < mCOMPOSE_TEXT.length && !end; i++) {
	                        ...
	                        g.setClip(ArrayPosX[i], pos_y,
	                        		...
	                        		Font.ms_Fonts[_iFontSize].getHeight());
	                        g.drawImage(Font.ms_Fonts[_iFontSize],
	                                ArrayPosX[i] - ((Font.getLetterPos(mCOMPOSE_TEXT[i].charAt(e))) * (Font.ms_Fonts[_iFontSize].getWidth() / Font.getNumberChars())),
	                                pos_y,
	                                Graphics.TOP | Graphics.LEFT);
	                        */
                                g.drawRegion(
                                        Font.ms_Fonts[_iFontSize],
                                        ((Font.getLetterPos(mCOMPOSE_TEXT[i].charAt(e))) * (Font.ms_Fonts[_iFontSize].getWidth() / Font.getNumberChars())),
                                        0,
                                        Font.ms_Fonts[_iFontSize].getWidth() / Font.getNumberChars(),
                                        Font.ms_Fonts[_iFontSize].getHeight(),
                                        ArrayPosX[i],
                ...
                case ALING_LEFT:
                    ...
                    if(number_leters > 0 || number_leters == -1)
                        for (int i = 0; i < mCOMPOSE_TEXT.length && !end; i++) {
	                        ...
	                        g.drawImage(Font.ms_Fonts[_iFontSize],
	                                posX - ((Font.getLetterPos(mCOMPOSE_TEXT[i].charAt(e))) * (Font.ms_Fonts[_iFontSize].getWidth() / Font.getNumberChars())),
