...
public class Settings {
	...
	public void init(Activity activity, boolean[] resolutionAvailableSet, int screenOrientation){
        ...
        Log.i("Debug", "SDK: " + currentApiVersion);
        ...
        //A partir de KITKAT es posible remover la barra de menu. Uso reflexi�n para saber si la clase contiene el metodo 'getRealMetrics'
        try {
